...
{
    public static class ReplaySystemManagerV2
    {
        ...
        private static NewReplaySystemV2 _replay;
        ...
        public static NewReplaySystemV2.ReplayState ResolveLoadReplay(string replayId, LevelSelectController levelSelectControllerInstance)
        {
            _replay.ClearData();
            NewReplaySystemV2.ReplayState replayState = _replay.LoadReplay(replayId);
            switch (replayState)
            {
                case NewReplaySystemV2.ReplayState.ReplayLoadSuccess:
                    _replayFileName = replayId;
                    gameSpeedMultiplier = _replay.GetReplaySpeed;
                    levelSelectControllerInstance.playbtn.onClick?.Invoke();
                    break;

                case NewReplaySystemV2.ReplayState.ReplayLoadNotFound:
                ...
                case NewReplaySystemV2.ReplayState.ReplayLoadErrorIncompatible:
                    break;
                case NewReplaySystemV2.ReplayState.ReplayLoadError:
                    break;
