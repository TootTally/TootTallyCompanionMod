    ...
    public class NewReplaySystem
    {
        ...
        public void RecordFrameData(GameController __instance)
        {
            ...
            if (SpectatingManager.IsHosting)
                SpectatingManager.hostedSpectatingSystem.SendFrameData(__instance.musictrack.time, __instance.noteholderr.anchoredPosition.x, __instance.pointer.transform.localPosition.y, __instance.isNoteButtonPressed());
        }
